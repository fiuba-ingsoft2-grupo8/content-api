...
from controllers import songs_controller, playlists_controller, liked_songs_controller, history_controller, collections_controller, metrics_controller, search_controller, about_controller, activity_controller, share_controller, preferences_controller, recomendations_controller
...
app.include_router(recomendations_controller.router, prefix="/recommendations", tags=["recommendations"])
